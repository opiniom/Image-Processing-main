...
def ahf_filter(A, return_route=False, return_stats=False, verbose=True):
    if verbose:
        print("\n[알림] Algorithm.txt 기반 적응형 하이브리드 필터 (AHF)를 시작합니다...")
